...
<!--<![endif]-->
    ...
    <div id="tc-page-wrap" class="<?php echo implode( " ", apply_filters('tc_page_wrap_class', array() ) ) ?>">
  		...
  		<?php do_action( '__before_header' ); ?>
            ...
            <div class="panel_under_header row-fluid mobile-hide">
                <div class="span8">
                <?php woocommerce_breadcrumb(); ?>
                </div>

                <?php if ( is_active_sidebar( 'footer_bar_1' ) ) : ?>
                    <div id="primary-sidebar" class="primary-sidebar widget-area span4" role="complementary">
                        <?php dynamic_sidebar( 'footer_bar_1' ); ?>
                    </div><!-- #primary-sidebar -->
                <?php endif; ?>

            </div>
            <div class="<?php echo implode( " ", apply_filters('tc_header_classes', array('row-fluid') ) ) ?>">
            <?php
  				...
  				do_action( '__header' );
  			?>
                <div class="mobile-show dropdown-cart-block">
                <?php dynamic_sidebar( 'footer_bar_1' ); ?>
                </div>
            </div>
  		</header>
