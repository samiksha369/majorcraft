...
<div class="images">
	...
	<?php
		if ( has_post_thumbnail() ) {
			...
			$image       	= get_the_post_thumbnail( $product->post->ID, 'full', array(
				'title'	=> $image_title,
				'alt'	=> $image_title
				) );
			...
			echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="woocommerce-main-image zoom" title="%s" data-rel="prettyPhoto' . $gallery . '">%s</a>', $image_link, $image_caption, $image ), $product->post->ID );
